...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "article_details": MessageLookupByLibrary.simpleMessage("تفاصيل المقالة"),
    ...
    "ny_times_most_popular": MessageLookupByLibrary.simpleMessage(
      "NY Times الأكثر شيوعاً في",
    ),
    "period": MessageLookupByLibrary.simpleMessage("الفترة"),
    "pull_up_load": MessageLookupByLibrary.simpleMessage("اسحب للتحميل"),
    "release_to_load": MessageLookupByLibrary.simpleMessage(
      "حرر لتحميل المزيد",
    ),
